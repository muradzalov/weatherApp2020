  ...
  return (
    <div className="container">
      ...
      */}
      ...
      <div className="title">GeoWeather</div>
      ...
      {errorScreen && (
        <ErrorHandler errorMessage={errorMessage} errorColor={errorColor} />
      )}
      ...
      {images.length > 0 && (
        <img
          ...
          alt="Input city"
          className="sample-image margin-top-24"
          src={`${images[showImage].urls.full}`}
        />
      )}
    </div>
  );
